// -- Global Names
const String tAppName = "Auth Ref";
...
// -- OnBoarding Text
const String tOnboardingTitle1 = "Old is Gold";
...
const String tOnboardingSubTitle1 =
    "Let's start your journey with us on this amazing and easy onboarding";
const String tOnboardingSubTitle2 =
    "Get Video Tutorials of wach topic to learn things easily.";
...
const String tWelcomeSubTitle =
    "Using the creativity and the finance to ensure a sustainable lifestyle.";
...
const String tForgetPasswordSubtitle =
    "Select from one of the option given below to reset your password.";
